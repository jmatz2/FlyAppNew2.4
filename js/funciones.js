...
function boletos(idc){
    ...
    request.open("GET","boletos.php?id="+idv+"&clase="+clss+"&cliente="+idc+"&adul="+numadultos+"&men="+nummenor+"&inf="+numinfante+"&asiento="+asiento,true);
    request.onreadystatechange=function(){
    if(this.readyState==4){
        if(this.status==200){
            if(this.responseText!=null){
...
function adquirir(){
    ...
    request.open("GET","clientes.php?nombre="+nom+"&appat="+app+"&apmat="+apm+"&tarj="+nt+"&nip="+nip+"&pais="+pais+"&estado="+estado+"&dir="+dir+"&tel="+tel+"&cel="+cel+"&mail="+mail+"&palabra="+secret+
...
function recogerDatos(){
  ...
  request.open("GET","personasPagar.php?id="+idv+"&clase="+clss+"&adul="+adultos+"&men="+menores+"&inf="+infantes,true);
    request.onreadystatechange=function(){
    if(this.readyState==4){
        if(this.status==200){
            if(this.responseText!=null){
...
function verId(id, clase){    
    idv=id;
    clss=clase;
    request.open("GET","conceptosFactura.php?id="+id,true);
    request.onreadystatechange=function(){
    if(this.readyState==4){
        if(this.status==200){
            if(this.responseText!=null){
...
function reservar(){     
    request.open("GET","consultarAsientos.php?id="+idv+"&clase="+clss,true);
    request.onreadystatechange=function(){
    if(this.readyState==4){
        if(this.status==200){
            if(this.responseText!=null){
...
request=new getAjax();
request.open("GET","aerolinea.php?",true);
request.onreadystatechange=function(){
    if(this.readyState==4){
        if(this.status==200){
            if(this.responseText!=null){
                document.getElementById("divCargarAerolineas").innerHTML=this.responseText;
            }
        }
    }
}
...
request.open("GET","aeropuertos.php?pais="+pais,true);
request.onreadystatechange=function(){
    if(this.readyState==4){
        if(this.status==200){
            if(this.responseText!=null){
...
request.open("GET","aeropuertosOrigen.php?pais="+pais,true);
request.onreadystatechange=function(){
    if(this.readyState==4){
        if(this.status==200){
            if(this.responseText!=null){
...
request=new getAjax();
request.open("GET","pais.php?",true);
request.onreadystatechange=function(){
    if(this.readyState==4){
        if(this.status==200){
            if(this.responseText!=null){
...
request=new getAjax();
request.open("GET","pais2.php?",true);
request.onreadystatechange=function(){
    if(this.readyState==4){
        if(this.status==200){
            if(this.responseText!=null){
...
request.open("GET","consultarVuelos.php?moneda="+moneda+"&origen="+origen+"&destino="+destino+"&fecha="+fecha,true);
request.onreadystatechange=function(){
    if(this.readyState==4){
        if(this.status==200){
            if(this.responseText!=null){
...
/*function aerolineas(){
var elementos = document.getElementsByName("aerolineas");
for(i=0;i<elementos.length;i++){
if(elementos[i].checked) {
...
/*function asientosDisp(ress){
request=new getAjax();
request.open("GET","consultarAsientos.php?id="+ress,true);
request.onreadystatechange=function(){
    if(this.readyState==4){
        if(this.status==200){
            if(this.responseText!=null){
